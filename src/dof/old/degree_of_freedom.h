...
template < class DataType > class DegreeOfFreedom {
public:
  ...
  /// cell index
  void get_coord_on_cell(int var, int cell_index,
                         std::vector< Coord > &coords) const;

  /// Get the global DofIds on a specific mesh cell and variable
  void get_dofs_on_cell(int var, int cell_index,
  ...
  void get_coord_on_subentity(int var, int cell_index, int tdim, int sindex,
                              std::vector< Coord > &coords) const;

  /// Get the global DofIds on a subentity (point, edge, fase) of a cell
  void get_dofs_on_subentity(int var, int cell_index, int tdim, int sindex,
                             std::vector< DofID > &ids) const;
