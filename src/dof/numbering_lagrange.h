...
public:
  ...
  void number_locally(DOF_ORDERING order = HIFLOW_CLASSIC);
...
private:
  ...
  void compute_weights (mesh::Entity const &cellA, doffem::RefElement< DataType, DIM > const &ansatzA, int facet_nr_A,
