...
template class EWForcing< la::LADescriptorBlock< la::LADescriptorCoupledD > >;
template class EWForcing< la::LADescriptorBlock< la::LADescriptorCoupledS > >;
template class EWForcing< la::LADescriptorPCE< la::LADescriptorCoupledD > >;
template class EWForcing< la::LADescriptorPCE< la::LADescriptorCoupledS > >;
template class EWForcing< la::LADescriptorPolynomialChaosD >;

#ifdef WITH_HYPRE
template class EWForcing< la::LADescriptorHypreD >;
template class EWForcing< la::LADescriptorPCE< la::LADescriptorHypreD > >;
template class EWForcing< la::LADescriptorBlock< la::LADescriptorHypreD > >;
#endif
