...
template < class DataType >
bool PeriodicBoundaryConditions< DataType >::insert_dof_id_entry(
...
template < class DataType >
void PeriodicBoundaryConditions< DataType >::apply_boundary_conditions(
...
template < class DataType >
void PeriodicBoundaryConditions< DataType >::add_boundary_tuple(
...
template < class DataType >
bool PeriodicBoundaryConditions< DataType >::is_periodic_boundary(
...
template < class DataType >
void PeriodicBoundaryConditions< DataType >::change_dofs(
    VectorSpace< DataType > &space) {
...
std::ostream &operator<<(std::ostream &s,
  ...
  typename std::map<
      typename PeriodicBoundaryConditions< DataType >::MaterialNumber,
      typename PeriodicBoundaryConditions< DataType >::MaterialNumber >::
      const_iterator it2;
