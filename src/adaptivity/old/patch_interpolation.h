...
template < class LAD, IMPL MESH_IMPL > class SpacePatchInterpolation {
...
public:
  ...
  ~SpacePatchInterpolation() { this->clear(); }
  ...
  virtual void interpolate(const VectorType &input_vector,
                           VectorType &vector) const;

  /// \brief set tolerance for identifying dofs by physical coordinates
  /// @param[in] eps tolerance

  virtual void set_dof_tolerance(DataType eps) { this->eps_ = eps; }

  /// \brief get patch interpolating vector space
  /// @return reference to space

  virtual VectorSpace< DataType > *get_space() { return &this->space_; }

  /// \brief get dof interpoaltion mapping
  /// @return reference to mapping

  virtual std::map< int, int > &get_mapping() { return this->high2low_; }

  /// \brief get linear algebra couplings, used for seeting up interpoalting
  /// vector by user
  /// @return reference to couplings

  virtual const LaCouplings &get_couplings() const { return this->couplings_; }
...
template < typename T, class DataType > class TimePatchInterpolation {
public:
  ...
  virtual T constant(const DataType c, const T &val_prev, const T &val,
  ...
  /// @param[in] val time dof value at time t_{n}
  /// @param[in] val_next time dof value at time t_{n+1}
  virtual T linear(const DataType c, const T &val_prev, const T &val,
                   const T &val_next) const;
  ...
  /// @param[in] val time dof value at time t_{n}
  /// @param[in] val_next time dof value at time t_{n+1}
  virtual T dt_linear(const DataType c, const T &val_prev, const T &val,
                      const T &val_next) const;
  ...
  /// @param[in] val time dof value at time t_{n}
  /// @param[in] val_next time dof value at time t_{n+1}
  virtual T patch_linear(const DataType c, const T &val_prev, const T &val,
                         const T &val_next) const;
  ...
  /// @param[in] val time dof value at time t_{n}
  /// @param[in] val_next time dof value at time t_{n+1}
  virtual T patch_dt_linear(const DataType c, const T &val_prev, const T &val,
                            const T &val_next) const;
  ...
  /// @param[in] val time dof value at time t_{n}
  /// @param[in] val_next time dof value at time t_{n+1}
  virtual T patch_quadratic(const DataType c, const T &val_prev, const T &val,
                            const T &val_next) const;
  ...
  /// @param[in] val time dof value at time t_{n}
  /// @param[in] val_next time dof value at time t_{n+1}
  virtual T patch_dt_quadratic(const DataType c, const T &val_prev,
                               const T &val, const T &val_next) const;
