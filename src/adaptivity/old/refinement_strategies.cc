...
template void get_equation_contributions < double>    ( int , EstimatorMode, int, int,
                                                        int, bool, const std::vector< std::vector< double > > &,
...
template < class DataType >
void sum_residuals_and_weights( int est_var, EstimatorMode est_mode, int num_eq, int num_steps,
                                int num_mesh, bool csi, const std::vector< std::vector< DataType > > &hK,
                                const std::vector< int > &indicator_mesh_indices,
                                const std::vector< std::vector< std::vector< DataType > > > &est_cell_residual,
                                const std::vector< std::vector< std::vector< DataType > > > &est_cell_timejump,
...
template void compute_space_time_estimators< double >(
    int num_steps, int num_mesh, const std::vector< int > &num_cells_per_mesh,
    const std::vector< int > &indicator_mesh_indices,
    const std::vector< mesh::MeshPtr > &mesh_list,
    const std::vector< std::vector< double > > &element_residual_h,
    ...
    std::vector< std::vector< double > > &time_indicator,
    std::vector< std::vector< double > > &space_indicator,
    double local_time_estimator, double local_space_estimator);
...
template void write_space_indicators_to_hdf5 <double> (const MPI_Comm&, const int, const int,
                                                       const std::string &, const std::string &, const std::string &,
                                                       const std::vector< std::vector< double > > &);

template void read_space_indicators_from_hdf5 <double> (const MPI_Comm&, const int, const int,
                                                        const std::string &, const std::string &, const std::string &,
                                                        std::vector< std::vector< double > > &);

template void write_spacetime_indicators_to_hdf5 <double> (const MPI_Comm&, const size_t, const size_t,
                                                           const std::string &, const std::string &, const std::string &,
                                                           const std::vector< std::vector< std::vector< double > > > &);
                                                        
template void read_spacetime_indicators_from_hdf5 <double> (const MPI_Comm&, const size_t, const size_t,
                                                            const std::string &, const std::string &, const std::string &,
