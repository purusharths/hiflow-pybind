...
#endif
  this->visualize(FeEvalCell<DataType, DIM>(this->space_, coeff, vars, nullptr), names); 
}
                                                      ...
                                                      const std::vector<std::string> &names) 
{
  ...
  this->visualize_grad(FeEvalCell<DataType, DIM>(this->space_, coeff, vars, nullptr), names); 
}
