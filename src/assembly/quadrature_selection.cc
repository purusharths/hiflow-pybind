...
//: last_ref_cell_type_(doffem::REF_CELL_NOT_SET), last_order_(-1) 
{
}
...
*/
    ...
    std::string quad_name = elem.ref_cell()->get_quad_name_cell_gauss (false); // false = not economical
                                                                 ...
                                                                 int facet_number) 
{
    ...
    {
      std::string quad_name = elem.ref_cell()->get_quad_name_facet_gauss (facet_number, false); // false = not economical
                                                                    ...
                                                                    Quadrature< DataType > &slave_quad) 
{
  ...
  {
    std::string quad_name = slave_elem.ref_cell()->get_quad_name_facet_gauss (slave_facet_number, true); // true = economical
