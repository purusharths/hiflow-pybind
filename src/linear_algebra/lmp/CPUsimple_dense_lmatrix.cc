...
template < typename ValueType >
void CPUsimple_DENSE_lMatrix< ValueType >::VectorMult(
  ...
  if ((casted_invec == NULL) && (casted_outvec == NULL)) {
    LOG_ERROR("CPUsimple_DENSE_lMatrix<ValueType>::VectorMult unsupported in "
              "or out vector");
    this->print();
    invec.print();
    outvec->print();
...
template < typename ValueType >
void CPUsimple_DENSE_lMatrix< ValueType >::CastFrom(
    const CPU_DENSE_lMatrix< double > &other) {
...
template < typename ValueType >
void CPUsimple_DENSE_lMatrix< ValueType >::CastFrom(
    const CPU_DENSE_lMatrix< float > &other) {
  assert(this->get_num_row() == other.get_num_row());
  assert(this->get_num_col() == other.get_num_col());
  assert(this->get_nnz() == other.get_nnz());
...
template < typename ValueType >
void CPUsimple_DENSE_lMatrix< ValueType >::CastTo(
    CPU_DENSE_lMatrix< double > &other) const {
  assert(this->get_num_row() == other.get_num_row());
  assert(this->get_num_col() == other.get_num_col());
  assert(this->get_nnz() == other.get_nnz());
...
template < typename ValueType >
void CPUsimple_DENSE_lMatrix< ValueType >::CastTo(
    CPU_DENSE_lMatrix< float > &other) const {
  assert(this->get_num_row() == other.get_num_row());
  assert(this->get_num_col() == other.get_num_col());
  assert(this->get_nnz() == other.get_nnz());
