...
CPUmkl_lVector< ValueType >::CPUmkl_lVector(const int size,
...
template < typename ValueType > CPUmkl_lVector< ValueType >::CPUmkl_lVector() {
#ifdef WITH_MKL
  this->implementation_name_ = "Intel/MKL";
  this->implementation_id_ = MKL;
  this->set_num_threads();
...
template < typename ValueType >
void CPUmkl_lVector< ValueType >::CloneFrom(
    const hiflow::la::lVector< ValueType > &other) {
  if (this != &other) {
    this->Clear();
  ...
  const CPUmkl_lVector< ValueType > *mkl_other =
      dynamic_cast< const CPUmkl_lVector< ValueType > * >(&other);
  if (mkl_other != 0) {
    this->set_num_threads(mkl_other->num_threads());
  } else {
    const CPUopenmp_lVector< ValueType > *omp_other =
        dynamic_cast< const CPUopenmp_lVector< ValueType > * >(&other);
    if (omp_other != 0) {
...
template <> int CPUmkl_lVector< double >::ArgMin(void) const {
#ifdef WITH_MKL
  int minimum = -1;
...
template <> int CPUmkl_lVector< float >::ArgMin(void) const {
#ifdef WITH_MKL
  int minimum = -1;
...
template <> int CPUmkl_lVector< double >::ArgMax(void) const {
#ifdef WITH_MKL
  int maximum = -1;
...
template <> int CPUmkl_lVector< float >::ArgMax(void) const {
#ifdef WITH_MKL
  int maximum = -1;
...
template <> double CPUmkl_lVector< double >::Norm1(void) const {
#ifdef WITH_MKL
  double nrm1 = -1;
...
template <> float CPUmkl_lVector< float >::Norm1(void) const {
#ifdef WITH_MKL
  float nrm1 = -1;
...
template <> double CPUmkl_lVector< double >::Norm2(void) const {
#ifdef WITH_MKL
  assert(this->get_size() > 0);
...
template <> float CPUmkl_lVector< float >::Norm2(void) const {
#ifdef WITH_MKL
  assert(this->get_size() > 0);
...
template < typename ValueType >
ValueType
CPUmkl_lVector< ValueType >::Dot(const lVector< ValueType > &vec) const {
  ValueType dot = 0.0;
...
template < typename ValueType >
void CPUmkl_lVector< ValueType >::Axpy(const lVector< ValueType > &vec,
...
template <>
void CPUmkl_lVector< double >::Axpy(const CPU_lVector< double > &vec,
                                    const double scalar) {
#ifdef WITH_MKL
...
template <>
void CPUmkl_lVector< float >::Axpy(const CPU_lVector< float > &vec,
                                   const float scalar) {
#ifdef WITH_MKL
...
template < typename ValueType >
void CPUmkl_lVector< ValueType >::ScaleAdd(const ValueType scalar,
...
template <>
void CPUmkl_lVector< double >::ScaleAdd(const double scalar,
...
template <>
void CPUmkl_lVector< float >::ScaleAdd(const float scalar,
...
template <> void CPUmkl_lVector< double >::Scale(const double scalar) {
#ifdef WITH_MKL
...
template <> void CPUmkl_lVector< float >::Scale(const float scalar) {
#ifdef WITH_MKL
...
template < typename ValueType >
void CPUmkl_lVector< ValueType >::Rot(lVector< ValueType > *vec,
                                      const ValueType &sc,
                                      const ValueType &ss) {
...
template <>
void CPUmkl_lVector< double >::Rot(CPU_lVector< double > *vec, const double &sc,
                                   const double &ss) {
#ifdef WITH_MKL
...
template <>
void CPUmkl_lVector< float >::Rot(CPU_lVector< float > *vec, const float &sc,
                                  const float &ss) {
#ifdef WITH_MKL
...
template <>
void CPUmkl_lVector< double >::Rotg(double *sa, double *sb, double *sc,
                                    double *ss) const {
#ifdef WITH_MKL
...
template <>
void CPUmkl_lVector< float >::Rotg(float *sa, float *sb, float *sc,
                                   float *ss) const {
#ifdef WITH_MKL
...
template < typename ValueType >
void CPUmkl_lVector< ValueType >::Rotm(lVector< ValueType > *vec,
...
template <>
void CPUmkl_lVector< double >::Rotm(CPU_lVector< double > *vec,
                                    const double &sparam) {
#ifdef WITH_MKL
...
template <>
void CPUmkl_lVector< float >::Rotm(CPU_lVector< float > *vec,
                                   const float &sparam) {
#ifdef WITH_MKL
...
template <>
void CPUmkl_lVector< double >::Rotmg(double *sd1, double *sd2, double *x1,
...
template <>
void CPUmkl_lVector< float >::Rotmg(float *sd1, float *sd2, float *x1,
