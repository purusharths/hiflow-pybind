...
lPreconditioner_ApproximateInverse<
    ValueType >::lPreconditioner_ApproximateInverse() {
  this->Operator_ = NULL;
  this->AI_ = NULL;
}
...
template < typename ValueType >
void lPreconditioner_ApproximateInverse< ValueType >::ApplylPreconditioner(
...
lPreconditioner_ApproximateInverse_FSAI<
    ValueType >::lPreconditioner_ApproximateInverse_FSAI() {
...
template < typename ValueType >
void lPreconditioner_ApproximateInverse_FSAI< ValueType >::set_matrix_power(
...
template < typename ValueType >
void lPreconditioner_ApproximateInverse_FSAI< ValueType >::
...
template < typename ValueType >
void lPreconditioner_ApproximateInverse_FSAI< ValueType >::SetupVector(
    const hiflow::la::lVector< ValueType > *x) {
  assert(x != NULL);
...
template < typename ValueType >
void lPreconditioner_ApproximateInverse_FSAI< ValueType >::ApplylPreconditioner(
    const hiflow::la::lVector< ValueType > &input,
    hiflow::la::lVector< ValueType > *output) {
