...
class lPreconditioner_ApproximateInverse
...
template < typename ValueType >
class lPreconditioner_ApproximateInverse_FSAI
    : public hiflow::la::lPreconditioner_ApproximateInverse< ValueType > {
public:
  lPreconditioner_ApproximateInverse_FSAI();
  virtual ~lPreconditioner_ApproximateInverse_FSAI();

  virtual void Init(void);
  virtual void Init(const int solver_max_iter, const ValueType solver_rel_eps,
