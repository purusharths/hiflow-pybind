...
template class FGMRES< LADescriptorPCE< LADescriptorCoupledD > >;
template class FGMRES< LADescriptorPCE< LADescriptorCoupledS > >;
template class FGMRES< LADescriptorBlock< LADescriptorCoupledD > >;
template class FGMRES< LADescriptorBlock< LADescriptorCoupledS > >;
template class FGMRES<
    LADescriptorGeneral< LADescriptorBlock< LADescriptorCoupledD > >,
    LADescriptorBlock< LADescriptorCoupledD > >;
template class FGMRES< LADescriptorPolynomialChaosD >;

#ifdef WITH_HYPRE
template class FGMRES< LADescriptorHypreD >;
template class FGMRES< LADescriptorPCE< LADescriptorHypreD > >;
template class FGMRES< LADescriptorBlock< LADescriptorHypreD > >;
