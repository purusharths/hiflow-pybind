...
template < class LAD > class UmfpackSolver : public LinearSolver< LAD > {
public:
  ...
  LinearSolverState SolveFactorized(const std::vector< DataType > &b,
...
private:
  ...
  LinearSolverState SolveImpl(const std::vector< DataType > &b,
                              std::vector< DataType > *x);
