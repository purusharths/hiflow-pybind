...
template < class DataType > FEInstance< DataType >::FEInstance() { id_ = 0; }

template < class DataType > FEInstance< DataType >::~FEInstance() { clear(); }
...
template < class DataType > void FEInstance< DataType >::clear() {
...
void FEInstance< DataType >::init_line_elements(
...
template < class DataType >
void FEInstance< DataType >::init_triangle_elements(
    const std::vector< Coord > &ref_coords) {
...
template < class DataType >
void FEInstance< DataType >::init_quadrilateral_elements(
    const std::vector< Coord > &ref_coords) {
...
template < class DataType >
void FEInstance< DataType >::init_tetrahedron_elements(
    const std::vector< Coord > &ref_coords) {
  assert(ref_coords.size() == 4);
...
template < class DataType >
void FEInstance< DataType >::init_hexahedron_elements(
    const std::vector< Coord > &ref_coords) {
...
template < class DataType >
void FEInstance< DataType >::init_pyramid_elements(
    const std::vector< Coord > &ref_coords) {
...
template < class DataType >
FELagrangeLine< DataType > *
FEInstance< DataType >::get_lagrange_line_element(int degree) {
...
template < class DataType >
FELagrangeTri< DataType > *
FEInstance< DataType >::get_lagrange_tri_element(int degree) {
...
template < class DataType >
FELagrangeQuad< DataType > *
FEInstance< DataType >::get_lagrange_quad_element(int degree) {
...
template < class DataType >
FELagrangeTet< DataType > *
FEInstance< DataType >::get_lagrange_tet_element(int degree) {
...
template < class DataType >
FELagrangeHex< DataType > *
FEInstance< DataType >::get_lagrange_hex_element(int degree) {
...
template < class DataType >
FELagrangePyr< DataType > *
FEInstance< DataType >::get_lagrange_pyr_element(int degree) {
...
template < class DataType >
FELagrangeLine< DataType > *
FEInstance< DataType >::get_const_lagrange_line_element(int degree) const {
  return fe_lag_line_[degree];
}

template < class DataType >
FELagrangeTri< DataType > *
FEInstance< DataType >::get_const_lagrange_tri_element(int degree) const {
  return fe_lag_tri_[degree];
}

template < class DataType >
FELagrangeQuad< DataType > *
FEInstance< DataType >::get_const_lagrange_quad_element(int degree) const {
  return fe_lag_quad_[degree];
}

template < class DataType >
FELagrangeTet< DataType > *
FEInstance< DataType >::get_const_lagrange_tet_element(int degree) const {
  return fe_lag_tet_[degree];
}

template < class DataType >
FELagrangeHex< DataType > *
FEInstance< DataType >::get_const_lagrange_hex_element(int degree) const {
  return fe_lag_hex_[degree];
}

template < class DataType >
FELagrangePyr< DataType > *
FEInstance< DataType >::get_const_lagrange_pyr_element(int degree) const {
  return fe_lag_pyr_[degree];
}

template < class DataType > void FEInstance< DataType >::get_status() const {
