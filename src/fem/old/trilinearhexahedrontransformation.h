...
/// a Hexahedron \author Michael Schick<br>Martin Baumann<br>Simon Gawlok
///

template < class DataType >
class TriLinearHexahedronTransformation
    : public CellTransformation< DataType > {
public:
...
protected:
  bool inverse_by_decomposition(DataType x_phy, DataType y_phy, DataType z_phy,
                                DataType &x_ref, DataType &y_ref,
                                DataType &z_ref) const;
