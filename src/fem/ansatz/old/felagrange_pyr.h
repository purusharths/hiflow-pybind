...
class FELagrangePyr : public FELagrange< DataType, DIM > {
public:
  ...
  std::string get_name() const { return "LagrangePyramid"; }
...
template < class DataType, int DIM > FELagrangePyr< DataType, DIM >::FELagrangePyr() {
  this->my_type_ = FEType< DataType, DIM >::LAGRANGE_PYR;
...
template < class DataType, int DIM > void FELagrangePyr< DataType, DIM >::init_coord() {
  assert (DIM == 3);
  ...
  if (this->my_deg_ == 0) {
    ...
    if (this->my_deg_ == 1) {
      ...
      std::cerr << "Unexpected finite element degree " << this->my_deg_
                << std::endl;
      exit(-1);
    }
...
template < class DataType, int DIM >
int FELagrangePyr< DataType, DIM >::ijk2ind(int i, int j, int k) const {
  assert (DIM == 3);
...
template < class DataType, int DIM >
void FELagrangePyr< DataType, DIM >::N(const Coord &pt,
  ...
  if (this->my_deg_ == 0) {
    ...
    case 2:
      ...
      weight[1] =
          -0.25 * z * (x + y + 2.0) + (0.25 * x + 0.25) * (-y + z + 1.0);
    ...
    case 1:
      ...
      weight[1] = -0.5 * pow(x, 2) * pow(y, 2) + 0.5 * pow(x, 2) * y * z +
                  0.5 * pow(x, 2) * y - 1.0 * pow(x, 2) * z -
                  0.5 * pow(y, 2) * z + 0.5 * pow(y, 2) + 0.5 * y * pow(z, 2) -
                  0.5 * y;
      weight[2] = -0.5 * z * (x - y) -
      ...
      weight[4] =
          ((z * (x - y + z + 1.0) + (x + 1.0) * (y - 1.0)) * (x + z - 1.0) +
           (z * (x + y - z - 1.0) + (x - 1.0) * (y - 1.0)) * (x - z + 1.0)) *
          (0.5 * y - 0.5 * z + 0.5);
      weight[5] = (-0.25 * y + 0.25 * z - 0.25) *
                  (x * (y - 1.0) * (x - z + 1.0) +
                   x * (y - 1.0) * (x + z + 1.0) + z * (2.0 * y + 1.0) - z);
      weight[6] = (-0.5 * (x - z) * (0.25 * y - 0.25 * z) * (-x + z + 1.0) +
                   0.125 * (x + z) * (y - z) * (x + z - 1.0)) *
                  (y - z + 1.0);
      weight[7] = -0.5 * y *
                  ((x - 1.0) * (x - z + 1.0) + (x + 1.0) * (x + z - 1.0)) *
                  (0.5 * y - 0.5 * z + 0.5);
      weight[8] = ((0.25 * x - 0.25 * z) * (y - z) * (x - z + 1.0) +
    ...
    case 2:
      weight[0] = (x + z) *
                  (-0.125 * (y - z) * (-y + z + 1.0) +
                   0.125 * (y + z) * (y + z - 1.0)) *
                  (x + z - 1.0);
      weight[1] = (x + z - 1) * (0.25 * y * (x + 1.0) * (-y + z + 1.0) -
      ...
      weight[4] = (0.5 * (z * (x - y + z + 1.0) + (x + 1.0) * (y - 1.0)) *
                       (y - z + 1.0) -
                   0.5 * (z * (x + y + z + 1.0) - (x + 1.0) * (y + 1.0)) *
                       (y + z - 1.0)) *
                  (x + z - 1.0);
      weight[5] = -0.5 * pow(x, 2) * pow(y, 2) - 0.5 * pow(x, 2) * z +
                  0.5 * pow(x, 2) - 0.5 * x * pow(y, 2) * z -
                  0.5 * x * pow(y, 2) - 0.5 * x * pow(z, 2) + 0.5 * x -
                  1.0 * pow(y, 2) * z;
      weight[6] = 0.125 * (x + z) *
    ...
    case 3:
      ...
      weight[6] = 0.5 * z * (x - y) +
                  0.5 * (0.25 * x - 0.25 * z) * (y + z) *
                      (4.0 * z - (-x + z + 1.0) * (y + z + 1.0)) +
                  0.125 * (x + z) * (y + z) * (x + z - 1.0) * (y + z + 1.0);
      weight[7] = -0.5 * pow(x, 2) * pow(y, 2) - 0.5 * pow(x, 2) * y * z -
                  0.5 * pow(x, 2) * y - 1.0 * pow(x, 2) * z -
                  0.5 * pow(y, 2) * z + 0.5 * pow(y, 2) - 0.5 * y * pow(z, 2) +
                  0.5 * y;
      weight[8] =
    ...
    case 4:
      ...
      weight[2] =
          ...
          (x - z + 1.0);
      weight[3] = -0.5 * pow(x, 2) * pow(y, 2) - 0.5 * pow(x, 2) * z +
                  0.5 * pow(x, 2) + 0.5 * x * pow(y, 2) * z +
                  0.5 * x * pow(y, 2) + 0.5 * x * pow(z, 2) - 0.5 * x -
                  1.0 * pow(y, 2) * z;
      weight[4] =
      ...
      weight[7] =
          ...
          0.5 * (0.5 * x - 0.5 * z + 0.5) *
              (y * (x - 1.0) * (y + z + 1.0) + z * (2.0 * x + 1.0) - z);
      weight[8] = (0.5 * (0.25 * x - 0.25 * z) * (y - z) * (y - z + 1.0) +
...
template < class DataType, int DIM >
void FELagrangePyr< DataType, DIM >::N_x(const Coord &pt,
                                    std::vector< DataType > &weight) const {
  assert (DIM == 3);
  assert(weight.size() == this->get_nb_dof_on_cell());
  ...
  if (this->my_deg_ == 0) {
    ...
    switch (indicator) {
    case 1:
      weight[0] = 0.5 * x * pow(y, 2) - 1.0 * x * y * z - 0.5 * x * y +
                  0.5 * x * pow(z, 2) + 0.5 * x * z - 0.25 * pow(y, 2) +
                  0.25 * y + 0.25 * pow(z, 2) + 0.25 * z;
      weight[1] = x * (-1.0 * pow(y, 2) + 1.0 * y * z + 1.0 * y - 2.0 * z);
      weight[2] = 0.5 * x * pow(y, 2) - 1.0 * x * y * z - 0.5 * x * y +
                  0.5 * x * pow(z, 2) + 0.5 * x * z + 0.25 * pow(y, 2) -
                  0.25 * y - 0.25 * pow(z, 2) - 0.25 * z;
      ...
      weight[8] = (y - z + 1.0) * (0.5 * (0.25 * x - 0.25 * z) * (y - z) +
      ...
      break;
    case 2:
      weight[0] = 0.5 * x * pow(y, 2) - 0.5 * x * y + 0.5 * x * pow(z, 2) +
                  0.5 * pow(y, 2) * z - 0.25 * pow(y, 2) - 0.5 * y * z +
                  0.25 * y + 0.5 * pow(z, 3) - 0.25 * pow(z, 2);
      weight[1] = -1.0 * x * pow(y, 2) + 1.0 * x * y - 1.0 * x * z -
                  0.5 * pow(y, 2) * z + 0.5 * y * z - 0.5 * pow(z, 2) + 0.5 * z;
      weight[2] = 0.5 * x * pow(y, 2) - 0.5 * x * y + 0.5 * x * pow(z, 2) +
                  0.5 * pow(y, 2) * z + 0.25 * pow(y, 2) - 0.25 * y +
                  0.5 * pow(z, 3) - 0.25 * pow(z, 2) - 0.5 * z;
      weight[3] = -1.0 * x * pow(y, 2) - 1.0 * x * z + 1.0 * x -
                  0.5 * pow(y, 2) * z + 0.5 * pow(y, 2) - 0.5 * pow(z, 2) +
                  1.0 * z - 0.5;
      weight[4] = 2.0 * x * pow(y, 2) - 2.0 * x * pow(z, 2) + 4.0 * x * z -
                  2.0 * x - 2.0 * pow(z, 3) + 3.0 * pow(z, 2) - 1.0 * z;
      weight[5] = -(0.5 * (y - 1.0) * (0.5 * y - 0.5 * z + 0.5) +
                    0.25 * (y + 1.0) * (y + z - 1)) *
                  (2 * x + z + 1.0);
      weight[6] = 0.5 * x * pow(y, 2) + 0.5 * x * y + 0.5 * x * pow(z, 2) +
                  0.5 * pow(y, 2) * z - 0.25 * pow(y, 2) + 0.5 * y * z -
                  0.25 * y + 0.5 * pow(z, 3) - 0.25 * pow(z, 2);
      weight[7] = -1.0 * x * pow(y, 2) - 1.0 * x * y - 1.0 * x * z -
                  0.5 * pow(y, 2) * z - 0.5 * y * z - 0.5 * pow(z, 2) + 0.5 * z;
      weight[8] = 0.5 * x * pow(y, 2) + 0.5 * x * y + 0.5 * x * pow(z, 2) +
                  0.5 * pow(y, 2) * z + 0.25 * pow(y, 2) + 0.25 * y +
                  0.5 * pow(z, 3) - 0.25 * pow(z, 2) - 0.5 * z;
      weight[9] = 1.0 * z * (y - 1);
      weight[10] = 1.0 * z * (-y + 1);
    ...
    case 3:
      ...
      weight[3] = -0.25 * (y + 1) *
                  (x * (y + z - 1.0) - (-2 * x + z + 1.0) * (y + z - 1) +
                   (x + z - 1) * (y + z - 1.0));
      weight[4] = x * (2.0 * pow(y, 2) - 2.0 * pow(z, 2) + 4.0 * z - 2.0);
      weight[5] = -1.0 * x * pow(y, 2) - 1.0 * x * y * z - 1.0 * x * z +
                  1.0 * x - 0.5 * pow(y, 2) - 0.5 * y * z - 0.5 * z + 0.5;
      weight[6] = 0.5 * x * pow(y, 2) + 1.0 * x * y * z + 0.5 * x * y +
                  0.5 * x * pow(z, 2) + 0.5 * x * z - 0.25 * pow(y, 2) -
                  0.25 * y + 0.25 * pow(z, 2) + 0.25 * z;
      weight[7] = -x * (1.0 * pow(y, 2) + 1.0 * y * z + 1.0 * y + 2.0 * z);
      weight[8] = 0.5 * x * pow(y, 2) + 1.0 * x * y * z + 0.5 * x * y +
                  0.5 * x * pow(z, 2) + 0.5 * x * z + 0.25 * pow(y, 2) +
                  0.25 * y - 0.25 * pow(z, 2) - 0.25 * z;
    ...
    case 4:
      ...
      weight[2] = 0.5 * x * pow(y, 2) - 0.5 * x * y + 0.5 * x * pow(z, 2) -
                  0.5 * pow(y, 2) * z + 0.25 * pow(y, 2) + 0.5 * y * z -
                  0.25 * y - 0.5 * pow(z, 3) + 0.25 * pow(z, 2);
      weight[3] = (-0.5 * (y - 1.0) * (0.5 * y - 0.5 * z + 0.5) -
                   0.25 * (y + 1.0) * (y + z - 1)) *
                  (2 * x - z - 1.0);
      weight[4] = 2.0 * x * pow(y, 2) - 2.0 * x * pow(z, 2) + 4.0 * x * z -
                  2.0 * x + 2.0 * pow(z, 3) - 3.0 * pow(z, 2) + 1.0 * z;
      weight[5] = -1.0 * x * pow(y, 2) - 1.0 * x * z + 1.0 * x +
                  0.5 * pow(y, 2) * z - 0.5 * pow(y, 2) + 0.5 * pow(z, 2) -
                  1.0 * z + 0.5;
      weight[6] = 0.5 * x * pow(y, 2) + 0.5 * x * y + 0.5 * x * pow(z, 2) -
                  0.5 * pow(y, 2) * z - 0.25 * pow(y, 2) - 0.25 * y -
...
template < class DataType, int DIM >
void FELagrangePyr< DataType, DIM >::N_y(const Coord &pt,
                                    std::vector< DataType > &weight) const {
  assert (DIM == 3);
  assert(weight.size() == this->get_nb_dof_on_cell());
  ...
  if (this->my_deg_ == 0) {
    ...
    switch (indicator) {
    case 1:
      weight[0] = 0.5 * pow(x, 2) * y - 0.5 * pow(x, 2) * z - 0.25 * pow(x, 2) -
                  0.5 * x * y + 0.25 * x + 0.5 * y * pow(z, 2) -
                  0.5 * pow(z, 3) + 0.25 * pow(z, 2) + 0.5 * z;
      weight[1] = (-0.5 * (x - 1.0) * (0.5 * x - 0.5 * z + 0.5) -
                   0.25 * (x + 1.0) * (x + z - 1)) *
                  (2 * y - z - 1.0);
      weight[2] = 0.5 * pow(x, 2) * y - 0.5 * pow(x, 2) * z - 0.25 * pow(x, 2) +
                  0.5 * x * y - 0.25 * x + 0.5 * y * pow(z, 2) -
                  0.5 * pow(z, 3) + 0.25 * pow(z, 2) + 0.5 * z;
      weight[3] = -1.0 * pow(x, 2) * y + 0.5 * pow(x, 2) * z + 1.0 * x * y -
                  0.5 * x * z - 1.0 * y * z + 0.5 * pow(z, 2) - 0.5 * z;
      weight[4] = 2.0 * pow(x, 2) * y - 2.0 * y * pow(z, 2) + 4.0 * y * z -
                  2.0 * y + 2.0 * pow(z, 3) - 3.0 * pow(z, 2) + 1.0 * z;
      weight[5] = -1.0 * pow(x, 2) * y + 0.5 * pow(x, 2) * z - 1.0 * x * y +
                  0.5 * x * z - 1.0 * y * z + 0.5 * pow(z, 2) - 0.5 * z;
      weight[6] = 0.5 * pow(x, 2) * y - 0.5 * pow(x, 2) * z + 0.25 * pow(x, 2) -
                  0.5 * x * y + 0.5 * x * z - 0.25 * x + 0.5 * y * pow(z, 2) -
                  0.5 * pow(z, 3) + 0.25 * pow(z, 2);
      weight[7] = -1.0 * pow(x, 2) * y + 0.5 * pow(x, 2) * z - 0.5 * pow(x, 2) -
                  1.0 * y * z + 1.0 * y + 0.5 * pow(z, 2) - 1.0 * z + 0.5;
      weight[8] = 0.5 * pow(x, 2) * y - 0.5 * pow(x, 2) * z + 0.25 * pow(x, 2) +
                  0.5 * x * y - 0.5 * x * z + 0.25 * x + 0.5 * y * pow(z, 2) -
                  0.5 * pow(z, 3) + 0.25 * pow(z, 2);
      weight[9] = 1.0 * z * (x - 1);
      weight[10] = -1.0 * z * (x + 1);
    ...
    case 2:
      ...
      weight[2] = 0.5 * pow(x, 2) * y - 0.25 * pow(x, 2) + 1.0 * x * y * z +
                  0.5 * x * y - 0.25 * x + 0.5 * y * pow(z, 2) + 0.5 * y * z +
                  0.25 * pow(z, 2) + 0.25 * z;
      ...
      weight[7] = -1.0 * pow(x, 2) * y - 0.5 * pow(x, 2) - 1.0 * x * y * z -
                  0.5 * x * z - 1.0 * y * z + 1.0 * y - 0.5 * z + 0.5;
      weight[8] = 0.5 * pow(x, 2) * y + 0.25 * pow(x, 2) + 1.0 * x * y * z +
                  0.5 * x * y + 0.25 * x + 0.5 * y * pow(z, 2) + 0.5 * y * z -
                  0.25 * pow(z, 2) - 0.25 * z;
    ...
    case 3:
      weight[0] = 0.5 * pow(x, 2) * y + 0.5 * pow(x, 2) * z - 0.25 * pow(x, 2) -
                  0.5 * x * y - 0.5 * x * z + 0.25 * x + 0.5 * y * pow(z, 2) +
                  0.5 * pow(z, 3) - 0.25 * pow(z, 2);
      weight[1] = -1.0 * pow(x, 2) * y - 0.5 * pow(x, 2) * z + 0.5 * pow(x, 2) -
                  1.0 * y * z + 1.0 * y - 0.5 * pow(z, 2) + 1.0 * z - 0.5;
      weight[2] = 0.5 * pow(x, 2) * y + 0.5 * pow(x, 2) * z - 0.25 * pow(x, 2) +
                  0.5 * x * y + 0.5 * x * z - 0.25 * x + 0.5 * y * pow(z, 2) +
                  0.5 * pow(z, 3) - 0.25 * pow(z, 2);
      ...
      weight[6] = 0.5 * pow(x, 2) * y + 0.5 * pow(x, 2) * z + 0.25 * pow(x, 2) -
                  0.5 * x * y - 0.25 * x + 0.5 * y * pow(z, 2) +
                  0.5 * pow(z, 3) - 0.25 * pow(z, 2) - 0.5 * z;
      weight[7] = -(0.5 * (x - 1.0) * (0.5 * x - 0.5 * z + 0.5) +
                    0.25 * (x + 1.0) * (x + z - 1)) *
                  (2 * y + z + 1.0);
      weight[8] = 0.5 * pow(x, 2) * y + 0.5 * pow(x, 2) * z + 0.25 * pow(x, 2) +
                  0.5 * x * y + 0.25 * x + 0.5 * y * pow(z, 2) +
      ...
      break;
    case 4:
      weight[0] = 0.5 * pow(x, 2) * y - 0.25 * pow(x, 2) - 1.0 * x * y * z -
                  0.5 * x * y + 0.25 * x + 0.5 * y * pow(z, 2) + 0.5 * y * z +
                  0.25 * pow(z, 2) + 0.25 * z;
      ...
      weight[6] = 0.5 * pow(x, 2) * y + 0.25 * pow(x, 2) - 1.0 * x * y * z -
                  0.5 * x * y - 0.25 * x + 0.5 * y * pow(z, 2) + 0.5 * y * z -
                  0.25 * pow(z, 2) - 0.25 * z;
      weight[7] = -1.0 * pow(x, 2) * y - 0.5 * pow(x, 2) + 1.0 * x * y * z +
                  0.5 * x * z - 1.0 * y * z + 1.0 * y - 0.5 * z + 0.5;
...
template < class DataType, int DIM >
void FELagrangePyr< DataType, DIM >::N_z(const Coord &pt,
                                    std::vector< DataType > &weight) const {
  assert (DIM == 3);
  assert(weight.size() == this->get_nb_dof_on_cell());
  ...
  if (this->my_deg_ == 0) {
    ...
    switch (indicator) {
    case 1:
      weight[0] = -0.5 * pow(x, 2) * y + 0.5 * pow(x, 2) * z +
                  0.25 * pow(x, 2) + 0.5 * x * z + 0.25 * x +
                  0.5 * pow(y, 2) * z - 1.5 * y * pow(z, 2) + 0.5 * y * z +
                  0.5 * y + 1.0 * pow(z, 3) - 0.75 * pow(z, 2);
      weight[1] =
          0.5 * pow(x, 2) * y - 1.0 * pow(x, 2) - 0.5 * pow(y, 2) + 1.0 * y * z;
      weight[2] = -0.5 * pow(x, 2) * y + 0.5 * pow(x, 2) * z +
                  0.25 * pow(x, 2) - 0.5 * x * z - 0.25 * x +
                  0.5 * pow(y, 2) * z - 1.5 * y * pow(z, 2) + 0.5 * y * z +
                  0.5 * y + 1.0 * pow(z, 3) - 0.75 * pow(z, 2);
      weight[3] = 0.5 * pow(x, 2) * y - 0.5 * pow(x, 2) - 0.5 * x * y +
                  0.5 * x - 0.5 * pow(y, 2) + 1.0 * y * z - 0.5 * y;
      weight[4] = -2.0 * pow(x, 2) * z + 2.0 * pow(x, 2) - 2.0 * pow(y, 2) * z +
                  2.0 * pow(y, 2) + 6.0 * y * pow(z, 2) - 6.0 * y * z +
                  1.0 * y - 4.0 * pow(z, 3) + 3.0 * pow(z, 2) + 4.0 * z - 3.0;
      weight[5] = 0.5 * pow(x, 2) * y - 0.5 * pow(x, 2) + 0.5 * x * y -
                  0.5 * x - 0.5 * pow(y, 2) + 1.0 * y * z - 0.5 * y;
      weight[6] = -0.5 * pow(x, 2) * y + 0.5 * pow(x, 2) * z -
                  0.25 * pow(x, 2) + 0.5 * x * y - 0.5 * x * z + 0.25 * x +
                  0.5 * pow(y, 2) * z - 1.5 * y * pow(z, 2) + 0.5 * y * z +
                  1.0 * pow(z, 3) - 0.75 * pow(z, 2);
      weight[7] = y * (0.5 * pow(x, 2) - 0.5 * y + 1.0 * z - 1.0);
      weight[8] = -0.5 * pow(x, 2) * y + 0.5 * pow(x, 2) * z -
                  0.25 * pow(x, 2) - 0.5 * x * y + 0.5 * x * z - 0.25 * x +
                  0.5 * pow(y, 2) * z - 1.5 * y * pow(z, 2) + 0.5 * y * z +
                  1.0 * pow(z, 3) - 0.75 * pow(z, 2);
      ...
      break;
    case 2:
      weight[0] = 0.5 * pow(x, 2) * z + 0.5 * x * pow(y, 2) - 0.5 * x * y +
                  1.5 * x * pow(z, 2) - 0.5 * x * z + 0.5 * pow(y, 2) * z -
                  0.25 * pow(y, 2) - 0.5 * y * z + 0.25 * y + 1.0 * pow(z, 3) -
                  0.75 * pow(z, 2);
      weight[1] = -0.5 * pow(x, 2) - 0.5 * x * pow(y, 2) + 0.5 * x * y -
                  1.0 * x * z + 0.5 * x - 0.5 * pow(y, 2) + 0.5 * y;
      weight[2] = 0.5 * pow(x, 2) * z + 0.5 * x * pow(y, 2) +
                  1.5 * x * pow(z, 2) - 0.5 * x * z - 0.5 * x +
                  0.5 * pow(y, 2) * z + 0.25 * pow(y, 2) + 0.5 * y * z +
                  0.25 * y + 1.0 * pow(z, 3) - 0.75 * pow(z, 2);
      weight[3] = x * (-0.5 * x - 0.5 * pow(y, 2) - 1.0 * z + 1.0);
      weight[4] = -2.0 * pow(x, 2) * z + 2.0 * pow(x, 2) - 6.0 * x * pow(z, 2) +
                  6.0 * x * z - 1.0 * x - 2.0 * pow(y, 2) * z +
                  2.0 * pow(y, 2) - 4.0 * pow(z, 3) + 3.0 * pow(z, 2) +
                  4.0 * z - 3.0;
      weight[5] = -0.5 * pow(x, 2) - 0.5 * x * pow(y, 2) - 1.0 * x * z -
                  1.0 * pow(y, 2);
      weight[6] = 0.5 * pow(x, 2) * z + 0.5 * x * pow(y, 2) + 0.5 * x * y +
                  1.5 * x * pow(z, 2) - 0.5 * x * z + 0.5 * pow(y, 2) * z -
                  0.25 * pow(y, 2) + 0.5 * y * z - 0.25 * y + 1.0 * pow(z, 3) -
                  0.75 * pow(z, 2);
      weight[7] = -0.5 * pow(x, 2) - 0.5 * x * pow(y, 2) - 0.5 * x * y -
                  1.0 * x * z + 0.5 * x - 0.5 * pow(y, 2) - 0.5 * y;
      weight[8] = 0.5 * pow(x, 2) * z + 0.5 * x * pow(y, 2) +
                  1.5 * x * pow(z, 2) - 0.5 * x * z - 0.5 * x +
                  0.5 * pow(y, 2) * z + 0.25 * pow(y, 2) - 0.5 * y * z -
                  0.25 * y + 1.0 * pow(z, 3) - 0.75 * pow(z, 2);
    ...
    case 3:
      weight[0] = 0.5 * pow(x, 2) * y + 0.5 * pow(x, 2) * z - 0.25 * pow(x, 2) -
                  0.5 * x * y - 0.5 * x * z + 0.25 * x + 0.5 * pow(y, 2) * z +
                  1.5 * y * pow(z, 2) - 0.5 * y * z + 1.0 * pow(z, 3) -
                  0.75 * pow(z, 2);
      ...
      weight[5] = -0.5 * pow(x, 2) * y - 0.5 * pow(x, 2) - 0.5 * x * y -
                  0.5 * x - 0.5 * pow(y, 2) - 1.0 * y * z + 0.5 * y;
      weight[6] = 0.5 * pow(x, 2) * y + 0.5 * pow(x, 2) * z + 0.25 * pow(x, 2) +
                  0.5 * x * z + 0.25 * x + 0.5 * pow(y, 2) * z +
                  1.5 * y * pow(z, 2) - 0.5 * y * z - 0.5 * y +
                  1.0 * pow(z, 3) - 0.75 * pow(z, 2);
      weight[7] = -0.5 * pow(x, 2) * y - 1.0 * pow(x, 2) - 0.5 * pow(y, 2) -
                  1.0 * y * z;
      weight[8] = 0.5 * pow(x, 2) * y + 0.5 * pow(x, 2) * z + 0.25 * pow(x, 2) -
                  0.5 * x * z - 0.25 * x + 0.5 * pow(y, 2) * z +
                  1.5 * y * pow(z, 2) - 0.5 * y * z - 0.5 * y +
      ...
      break;
    case 4:
      weight[0] = 0.5 * pow(x, 2) * z - 0.5 * x * pow(y, 2) -
                  1.5 * x * pow(z, 2) + 0.5 * x * z + 0.5 * x +
                  0.5 * pow(y, 2) * z + 0.25 * pow(y, 2) + 0.5 * y * z +
                  0.25 * y + 1.0 * pow(z, 3) - 0.75 * pow(z, 2);
      weight[1] = -0.5 * pow(x, 2) + 0.5 * x * pow(y, 2) - 0.5 * x * y +
                  1.0 * x * z - 0.5 * x - 0.5 * pow(y, 2) + 0.5 * y;
      weight[2] = 0.5 * pow(x, 2) * z - 0.5 * x * pow(y, 2) + 0.5 * x * y -
                  1.5 * x * pow(z, 2) + 0.5 * x * z + 0.5 * pow(y, 2) * z -
                  0.25 * pow(y, 2) - 0.5 * y * z + 0.25 * y + 1.0 * pow(z, 3) -
                  0.75 * pow(z, 2);
      weight[3] = -0.5 * pow(x, 2) + 0.5 * x * pow(y, 2) + 1.0 * x * z -
                  1.0 * pow(y, 2);
      weight[4] = -2.0 * pow(x, 2) * z + 2.0 * pow(x, 2) + 6.0 * x * pow(z, 2) -
                  6.0 * x * z + 1.0 * x - 2.0 * pow(y, 2) * z +
                  2.0 * pow(y, 2) - 4.0 * pow(z, 3) + 3.0 * pow(z, 2) +
      ...
      weight[6] = 0.5 * pow(x, 2) * z - 0.5 * x * pow(y, 2) -
                  1.5 * x * pow(z, 2) + 0.5 * x * z + 0.5 * x +
                  0.5 * pow(y, 2) * z + 0.25 * pow(y, 2) - 0.5 * y * z -
                  0.25 * y + 1.0 * pow(z, 3) - 0.75 * pow(z, 2);
      weight[7] = -0.5 * pow(x, 2) + 0.5 * x * pow(y, 2) + 0.5 * x * y +
                  1.0 * x * z - 0.5 * x - 0.5 * pow(y, 2) - 0.5 * y;
      weight[8] = 0.5 * pow(x, 2) * z - 0.5 * x * pow(y, 2) - 0.5 * x * y -
                  1.5 * x * pow(z, 2) + 0.5 * x * z + 0.5 * pow(y, 2) * z -
                  0.25 * pow(y, 2) + 0.5 * y * z - 0.25 * y + 1.0 * pow(z, 3) -
                  0.75 * pow(z, 2);
      weight[9] = 1.0 * x * y - 1.0 * x - 2.0 * y * z - 1.0 * y - 2.0 * z + 1.0;
...
template < class DataType, int DIM >
void FELagrangePyr< DataType, DIM >::N_xx(const Coord &pt,
                                     std::vector< DataType > &weight) const {
  assert (DIM == 3);
  assert(weight.size() == this->get_nb_dof_on_cell());
...
template < class DataType, int DIM >
void FELagrangePyr< DataType, DIM >::N_xy(const Coord &pt,
                                     std::vector< DataType > &weight) const {
  assert (DIM == 3);
  assert(weight.size() == this->get_nb_dof_on_cell());
...
template < class DataType, int DIM >
void FELagrangePyr< DataType, DIM >::N_xz(const Coord &pt,
                                     std::vector< DataType > &weight) const {
  assert (DIM == 3);
  assert(weight.size() == this->get_nb_dof_on_cell());
  ...
  if (this->my_deg_ == 0) {
    ...
    case 2:
      weight[0] =
          1.0 * x * z + 0.5 * pow(y, 2) - 0.5 * y + 1.5 * pow(z, 2) - 0.5 * z;
      weight[1] = -1.0 * x - 0.5 * pow(y, 2) + 0.5 * y - 1.0 * z + 0.5;
      weight[2] =
          1.0 * x * z + 0.5 * pow(y, 2) + 1.5 * pow(z, 2) - 0.5 * z - 0.5;
...
template < class DataType, int DIM >
void FELagrangePyr< DataType, DIM >::N_yy(const Coord &pt,
                                     std::vector< DataType > &weight) const {
  assert (DIM == 3);
  assert(weight.size() == this->get_nb_dof_on_cell());
...
template < class DataType, int DIM >
void FELagrangePyr< DataType, DIM >::N_yz(const Coord &pt,
                                     std::vector< DataType > &weight) const {
  assert (DIM == 3);
  assert(weight.size() == this->get_nb_dof_on_cell());
  ...
  if (this->my_deg_ == 0) {
    ...
    case 1:
      weight[0] =
          -0.5 * pow(x, 2) + 1.0 * y * z - 1.5 * pow(z, 2) + 0.5 * z + 0.5;
      ...
      weight[6] =
          -0.5 * pow(x, 2) + 0.5 * x + 1.0 * y * z - 1.5 * pow(z, 2) + 0.5 * z;
...
template < class DataType, int DIM >
void FELagrangePyr< DataType, DIM >::N_zz(const Coord &pt,
                                     std::vector< DataType > &weight) const {
  assert (DIM == 3);
  assert(weight.size() == this->get_nb_dof_on_cell());
  ...
  if (this->my_deg_ == 0) {
    ...
    switch (indicator) {
    case 1:
      weight[0] = 0.5 * pow(x, 2) + 0.5 * x + 0.5 * pow(y, 2) - 3.0 * y * z +
                  0.5 * y + 3.0 * pow(z, 2) - 1.5 * z;
      weight[1] = 1.0 * y;
      weight[2] = 0.5 * pow(x, 2) - 0.5 * x + 0.5 * pow(y, 2) - 3.0 * y * z +
                  0.5 * y + 3.0 * pow(z, 2) - 1.5 * z;
      weight[3] = 1.0 * y;
      weight[4] = -2.0 * pow(x, 2) - 2.0 * pow(y, 2) + 12.0 * y * z - 6.0 * y -
                  12.0 * pow(z, 2) + 6.0 * z + 4.0;
      weight[5] = 1.0 * y;
      weight[6] = 0.5 * pow(x, 2) - 0.5 * x + 0.5 * pow(y, 2) - 3.0 * y * z +
                  0.5 * y + 3.0 * pow(z, 2) - 1.5 * z;
      weight[7] = 1.0 * y;
      weight[8] = 0.5 * pow(x, 2) + 0.5 * x + 0.5 * pow(y, 2) - 3.0 * y * z +
                  0.5 * y + 3.0 * pow(z, 2) - 1.5 * z;
      weight[9] = -2.0 * x - 2.0;
      weight[10] = 2.0 * x - 2.0;
      weight[11] = 2.0 * x - 2.0;
      ...
      break;
    case 2:
      weight[0] = 0.5 * pow(x, 2) + 3.0 * x * z - 0.5 * x + 0.5 * pow(y, 2) -
                  0.5 * y + 3.0 * pow(z, 2) - 1.5 * z;
      weight[1] = -1.0 * x;
      weight[2] = 0.5 * pow(x, 2) + 3.0 * x * z - 0.5 * x + 0.5 * pow(y, 2) +
                  0.5 * y + 3.0 * pow(z, 2) - 1.5 * z;
      weight[3] = -1.0 * x;
      weight[4] = -2.0 * pow(x, 2) - 12.0 * x * z + 6.0 * x - 2.0 * pow(y, 2) -
                  12.0 * pow(z, 2) + 6.0 * z + 4.0;
      weight[5] = -1.0 * x;
      weight[6] = 0.5 * pow(x, 2) + 3.0 * x * z - 0.5 * x + 0.5 * pow(y, 2) +
                  0.5 * y + 3.0 * pow(z, 2) - 1.5 * z;
      weight[7] = -1.0 * x;
      weight[8] = 0.5 * pow(x, 2) + 3.0 * x * z - 0.5 * x + 0.5 * pow(y, 2) -
                  0.5 * y + 3.0 * pow(z, 2) - 1.5 * z;
      weight[9] = 2.0 * y - 2.0;
      weight[10] = -2.0 * y - 2.0;
      weight[11] = -2.0 * y - 2.0;
