...
EntityNumber Interface::master_index() const { return master_index_; }

int Interface::master_facet_number() const { return master_facet_number_; }
...
int Interface::num_slaves() const { return slave_indices_.size(); }
...
std::ostream &operator<<(std::ostream &os, const Interface &interface) {
  ...
  os << "\tslave cell indices = "
     << string_from_range(interface.begin(), interface.end()) << "\n";
  os << "}\n";
  return os;
}
...
ConstMeshPtr InterfaceList::mesh() const { return mesh_; }

int InterfaceList::size() const { return interfaces_.size(); }

InterfaceList::InterfaceList(ConstMeshPtr& mesh) : mesh_(mesh) {}

Interface &InterfaceList::add_interface(EntityNumber master_index,
                                        int master_facet_number) {
...
void InterfaceList::clear() { this->interfaces_.clear(); }
