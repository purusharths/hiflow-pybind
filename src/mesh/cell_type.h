...
public:
  ...
  std::vector< int >
  vertices_of_entity(TDim d, int i,
...
public:
  ...
  virtual bool check_cell_geometry(const std::vector< Coordinate > &coords,
                                   GDim gdim) const;
...
public:
  enum { TET_8TET_REFINEMENT_TYPE = 0, TET_4HEX_REFINEMENT_TYPE };
  friend class CellType;
...
public:
  enum { PYR_6PYR4TET_REFINEMENT_TYPE };
  friend class CellType;
