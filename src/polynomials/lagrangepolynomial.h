...
template < class T > T _lagrange_polynomial(int deg, int i, const T &x) {
  assert((i >= 0) && (i <= deg));
...
template < class T > T _lagrange_polynomial_x(int deg, int i, const T &x) {
  assert((i >= 0) && (i <= deg));
...
template < class T > T _lagrange_polynomial_xx(int deg, int i, const T &x) {
  assert((i >= 0) && (i <= deg));
...
template < class T > class LagrangePolynomial {
private:
