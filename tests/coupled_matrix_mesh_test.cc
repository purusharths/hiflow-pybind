...
#define BOOST_TEST_MODULE coupled_matrix_mesh
...
BOOST_AUTO_TEST_CASE(coupled_matrix_mesh1, *utf::tolerance(1.0e-12)) {
...
BOOST_AUTO_TEST_CASE(coupled_matrix_mesh2, *utf::tolerance(1.0e-12)) {
  MPI_Comm comm(MPI_COMM_WORLD);
