...
<<<<<<< HEAD:tests/point_evaluator_test.cc
                                                                   quadrature,
                                                                   false);
=======
        quadrature);
>>>>>>> master:tests/point_evaluator3D_test.cc
...
void PointEvalTest::prepare_system() {
  ...
  std::vector< FEType > fe_ansatz (1, FE_TYPE_BDM);
