              ...
              CoupledVector<DataType>& sol)
{
  ...
  compute_sparsity_structure(space, sparsity, coupling_vars);
...
int main(int argc, char *argv[]) {
  ...
  std::vector< FEType > lag_fe_ansatz2 (2, FE_TYPE_LAGRANGE);
  std::vector< FEType > lag_fe_ansatz3 (3, FE_TYPE_LAGRANGE);
  ...
  std::vector< std::vector< int > > lag_degrees3(2);
  ...
  for (int test_number = 0; test_number < filenames.size(); ++test_number) 
  {
    ...
    {
      for (int projection_type = 0; projection_type <= 2; ++projection_type)
      {
        for (int l=0; l<rt_degrees.size(); ++l)
        {
          CONSOLE_OUTPUT(rank, "------------------------ ");
          ...
          for (int i = 0; i < num_level; ++i) 
          {
            ...
            std::string filename = "FeProjectionTest_CellTri_lvl" + std::to_string(init_level + i) + "_RT" 
                                 + std::to_string(rt_degrees[l][0]) + "_proj" + std::to_string(projection_type) + ".vtu";
      ...
      for (int projection_type = 0; projection_type <= 2; ++projection_type)
      {
        for (int l=0; l<bdm_degrees.size(); ++l)
        {
          ...
          for (int i = 0; i < num_level; ++i) 
          {
            ...
            std::string filename = "FeProjectionTest_CellTri_lvl" + std::to_string(init_level + i) + "_BDM" 
                                 + std::to_string(bdm_degrees[l][0]) + "_proj" + std::to_string(projection_type) + ".vtu";
      ...
      for (int projection_type = 0; projection_type <= 2; ++projection_type)
      {
        for (int l=0; l<lag_degrees2.size(); ++l)
        {
          ...
          for (int i = 0; i < num_level; ++i) 
          {
            ...
            std::string filename = "FeProjectionTest_CellTri_lvl" + std::to_string(init_level + i) + "_LAG" 
                                 + std::to_string(bdm_degrees[l][0]) + "_proj" + std::to_string(projection_type) + ".vtu";
      ...
      for (int projection_type = 0; projection_type <= 2; ++projection_type)
      {
        for (int l=0; l<lag_degrees3.size(); ++l)
        {
          ...
          for (int i = 0; i < num_level; ++i) 
          {
            ...
            std::string filename = "FeProjectionTest_CellTri_lvl" + std::to_string(init_level + i) + "_LAG" 
                                 + std::to_string(lag_degrees3[l][0]) + "_proj" + std::to_string(projection_type) + ".vtu";
